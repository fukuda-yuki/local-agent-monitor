...
public sealed class RuntimeBackupLocalWorkspaceProjectionTests
{
    ...
    public void ValidationRejectsSemanticProjectionTampering(string mutation)
    {
        ...
        LocalWorkspaceProjectionSchemaTests.Execute(connection, """
            ...
            INSERT INTO session_event_content VALUES('0198f5b8-0c00-7000-8000-000000000002','application/json','{"message":"hello"}','2026-08-24T00:00:00.0000000+00:00','2099-01-01T00:00:00.0000000+00:00',randomblob(32));
            """);
