...
public sealed class SqliteMonitorRuntimeStateStoreTests
{
    ...
    private static void AssertMigrationResult(string databasePath)
    {
        ...
        Assert.Equal(
            (long)SqliteMonitorRuntimeStateStore.MonitorSchemaVersion,
            Scalar(connection, "SELECT version FROM schema_version WHERE component = 'monitor';"));
        ...
        Assert.Equal(
            ["501|completed|1|2026-07-12T00:00:01.0000000+00:00"],
