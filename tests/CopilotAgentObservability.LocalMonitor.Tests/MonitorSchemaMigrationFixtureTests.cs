...
{
    private const int CurrentMonitorSchemaVersion = 8;
    ...
    public void Historical_fixture_has_reproducible_provenance_and_preserves_complete_v8_state_across_two_restarts(int version, string sourceCommit)
    {
