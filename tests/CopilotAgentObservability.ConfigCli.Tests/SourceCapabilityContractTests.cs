...
public sealed class SourceCapabilityContractTests
{
    ...
    public void Claude_mapping_metadata_property_closures_and_multisets_are_exact()
    {
        ...
        AssertMappingHeader(otel.RootElement, "claude-code-otel",
        ...
        AssertMappingHeader(hook.RootElement, "claude-code-hook",
        ...
        AssertJsonExact(otel.RootElement.GetProperty("evidence_sources"), """[{"id":"official-monitoring","kind":"official_documentation","reference":"https://code.claude.com/docs/en/monitoring-usage","evidence_status":"documented_not_live_observed"},{"id":"inventory-interactive","kind":"approved_inventory","reference":"../inventories/claude-code-interactive.json","evidence_status":"blocked_no_producer_structure_observed"},{"id":"inventory-print","kind":"approved_inventory","reference":"../inventories/claude-code-print.json","evidence_status":"completed_no_producer_structure_observed"},{"id":"inventory-agent-sdk","kind":"approved_inventory","reference":"../inventories/claude-agent-sdk.json","evidence_status":"blocked_no_producer_structure_observed"},{"id":"no-producer-evidence","kind":"absence_record","reference":"../inventories/claude-code-print.json","evidence_status":"not_documented_or_live_observed"}]""");
        ...
        AssertJsonExact(otel.RootElement.GetProperty("surface_validation"), """[{"surface_mode":"interactive","state":"unverified","evidence_source":"inventory-interactive"},{"surface_mode":"print","state":"executed_no_structural_telemetry_observed","evidence_source":"inventory-print"},{"surface_mode":"agent-sdk","state":"unverified","evidence_source":"inventory-agent-sdk"}]""");
    ...
    public void Claude_documentation_only_evidence_remains_unknown_and_exact_binding_is_closed()
    {
        ...
        using var otel = ReadClaudeMapping("otel-mapping.json");
        using var hook = ReadClaudeMapping("hook-mapping.json");
        var expectedSurfaceStates = new[] { "unverified", "executed_no_structural_telemetry_observed", "unverified" };
        ...
        Assert.All(IndexFields(otel.RootElement).Values, field => Assert.Contains(
            ...
            new[] { "documented_not_live_observed", "not_documented_or_live_observed" }));
    ...
    [
        ...
        new("otel.span_name", "resourceSpans[].scopeSpans[].spans[].name", "string", true, "every OTLP span", "none", "documented_unmapped", "none", null, RawPayloadTarget),
        ...
        new("otel.user_prompt", "resourceSpans[].scopeSpans[].spans[claude_code.interaction].attributes[\"user_prompt\"]", "string", false, "span.name == \"claude_code.interaction\"", "OTEL_LOG_USER_PROMPTS=1", "raw_retained", "none", null, RawPayloadTarget),
    ...
    private static readonly IReadOnlyDictionary<string, ExpectedFieldDetail> ExpectedFieldDetails = ParseFieldDetails(
        ...
        otel.span_name|official-monitoring|documented_not_live_observed|producer_span_name|No normalization because MonitorSpanProjection.Operation is not a raw span-name field.|Keep Operation null unless a later adapter specifies an exact recognized-name transform.
        ...
        otel.user_prompt|official-monitoring|documented_not_live_observed|raw_prompt|Retain only inside the existing raw OTLP payload.|Never copy prompt content into sanitized DTOs.
    ...
    private static void AssertMappingHeader(JsonElement root, string adapter, string manifestRule)
    {
        ...
        Assert.Equal("documentation_only_not_live_observed", Value(root.GetProperty("mapping_status")));
