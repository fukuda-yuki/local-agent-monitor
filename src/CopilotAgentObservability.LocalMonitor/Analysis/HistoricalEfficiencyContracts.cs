...
{
    ProducerAuthoredRepeatedCallIdentityUnavailable,
    ExactToolFailureStatusUnavailable,
    PermissionWaitDurationUnavailable,
    ExactSubagentOwnershipUnavailable,
...
internal sealed record HistoricalEfficiencyDriverV1(
    ...
    [property: JsonPropertyOrder(3)] HistoricalEfficiencyDriverCategoryV1 Category,
    [property: JsonPropertyOrder(4)] int DriverVersion,
    [property: JsonPropertyOrder(5)] string RuleSource,
    [property: JsonPropertyOrder(6)] string Formula,
    [property: JsonPropertyOrder(7)] string Threshold,
    [property: JsonPropertyOrder(8)] string? SubjectSessionId,
    [property: JsonPropertyOrder(9)] IReadOnlyList<string> SourceSessions,
    [property: JsonPropertyOrder(10)] IReadOnlyList<HistoricalEvidenceReferenceV1> EvidenceRefs,
    [property: JsonPropertyOrder(11)] IReadOnlyList<HistoricalEvidenceReferenceV1> QualityEvidenceRefs,
    [property: JsonPropertyOrder(12)] IReadOnlyList<HistoricalEfficiencyScalarV1> ObservedValues,
    [property: JsonPropertyOrder(13)] HistoricalEfficiencyScalarV1? CohortMedian,
    [property: JsonPropertyOrder(14)] HistoricalEfficiencyPercentileV1? CohortPercentile,
    [property: JsonPropertyOrder(15)] HistoricalEfficiencySourceDistributionV1 SourceDistribution,
    [property: JsonPropertyOrder(16)] IReadOnlyList<HistoricalDistributionCountV1> CompletenessDistribution,
    [property: JsonPropertyOrder(17)] HistoricalEfficiencyQualityAvailabilityV1 QualityAvailability,
    [property: JsonPropertyOrder(18)] HistoricalEfficiencyDriverVerdictV1 Verdict,
    [property: JsonPropertyOrder(19)] IReadOnlyList<HistoricalEfficiencyComparisonNoteV1> ComparisonNotes,
    [property: JsonPropertyOrder(20)] string Summary,
    [property: JsonPropertyOrder(21)] HistoricalEfficiencyMitigationV1 Mitigation);
...
internal static class HistoricalEfficiencyDriverRegistryV1
{
    ...
    [
        ...
        Rule(HistoricalEfficiencyDriverCategoryV1.RetryOverhead, "retry-overhead", ["retry_chain"],
            "distinct_retry_attempts_minus_one", "retry_attempt_count_gte_2", 1, null, "review_retry_trigger"),
        Rule(HistoricalEfficiencyDriverCategoryV1.ToolCallVolume, "tool-call-volume", [],
            "producer_authored_repeated_call_identity_unavailable", "unavailable_in_historical_evidence_v1", 0,
        ...
        Rule(HistoricalEfficiencyDriverCategoryV1.PermissionWait, "permission-wait", [],
            "permission_wait_duration_unavailable", "unavailable_in_historical_evidence_v1", 0,
            HistoricalEfficiencyCoverageReasonV1.PermissionWaitDurationUnavailable, "review_permission_plan"),
        Rule(HistoricalEfficiencyDriverCategoryV1.SubagentFanout, "subagent-fanout", [],
            "exact_subagent_ownership_unavailable", "unavailable_in_historical_evidence_v1", 0,
