...
try {
 ...
 function Get-BlockerCode {
  ...
  if($value.driver_phase-cne'none'){$code+='_at_'+$value.driver_phase};if($value.poison_reason-cne'none'){$code+='_due_'+$value.poison_reason};return $code
 }
