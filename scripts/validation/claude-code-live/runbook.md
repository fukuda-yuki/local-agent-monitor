...
```powershell
pwsh -NoProfile -File scripts/validation/claude-code-live/preflight.ps1 `
...
The checked-in JSON files under `scripts/validation/claude-code-live/fixtures/` have a
...
```powershell
$FixturePath = Join-Path $PWD 'scripts/validation/claude-code-live/fixtures/otel-interaction-key-absent.json'
...
```powershell
pwsh -NoProfile -File scripts/validation/claude-code-live/new-marker.ps1
```
...
```powershell
pwsh -NoProfile -File scripts/validation/claude-code-live/scan-leaks.ps1 `
  -Marker $Marker `
  -RepositoryRoot $PWD `
...
```powershell
pwsh -NoProfile -File scripts/validation/claude-code-live/cleanup.ps1 `
