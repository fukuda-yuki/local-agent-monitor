...
| **[DOC-6E](#DOC-6E)** | Tracker hygiene (peripheral) | `docs/BUG_ISSUE/README.md` | Low | Fixed | インデックス表が DOC-1〜DOC-5C を "Open" のまま表示しており、`doc-ux-readability-issues.md` 側の "Fixed" 表記と矛盾している |
