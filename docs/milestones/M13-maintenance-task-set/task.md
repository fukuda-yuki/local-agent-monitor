...
- 2026-05-24: `rg -n "maint-(refactor|bug|test|review)-001|task.category|prompt.version|repo.snapshot|自動採用|自動実装|勝敗" docs/spec.md docs/milestones/M13-maintenance-task-set docs/milestones/M12-measurement-schema` で文書整合を確認した。
