...
- `docs/milestones/M18-baseline-dry-run/task.md`
- `docs/milestones/M18-baseline-dry-run/notes.md`
- `docs/milestones/M18-baseline-dry-run/review.md`
...
- `docs/milestones/M18-baseline-dry-run/task.md` に CLI 側 dry run と VS Code 側未実行の検証記録を追加した。
- `docs/milestones/M18-baseline-dry-run/notes.md` に sanitized な CLI 側実施概要、集計成立性、未完了範囲を記録した。
