...
- 2026-06-03: `docs/milestones/M23-failure-taxonomy/taxonomy.md` を追加し、failure category、anti-pattern、evidence requirements、severity、improvement target を定義した。
