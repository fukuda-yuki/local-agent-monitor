...
- `docs/milestones/M12-measurement-schema/task.md`
- `docs/milestones/M12-measurement-schema/notes.md`
- `docs/milestones/M12-measurement-schema/review.md`
- `docs/task.md`
...
- `rg -n "measurement schema|success_status|experiment\\.id|experiment\\.condition|prompt\\.version|agent\\.variant|turn_count|tool_call_count|M14|M16|M20|M21" docs/spec.md docs/milestones/M12-measurement-schema docs/requirements.md`
- `rg -n "自動採用|自動実装|勝敗の自動決定|Langfuse export|API|算出ルール|rubric|A/B" docs/spec.md docs/milestones/M12-measurement-schema`
