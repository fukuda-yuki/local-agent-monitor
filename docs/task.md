...
| Sprint2.5: ConfigCli Maintainability | 計画中 | [docs/sprints/sprint2-5-maintainability/](sprints/sprint2-5-maintainability/) で ConfigCli 保守性改善、CSV / JSON 共通処理集約、redacted real-trace E2E 確認を Sprint3 前の技術負債整理として扱う |
...
- Sprint2.5 は GitHub Issue #24 を正式な参照元とし、Sprint3 に進む前の技術負債整理として扱う。
- Sprint2.5 は M1 planning、M2 ConfigCli responsibility split、M3 output helper consolidation、M4 redacted real-trace E2E、M5 regression review and closeout の順に実施する。
