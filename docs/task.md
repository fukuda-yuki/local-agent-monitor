...
- Sprint3 M2-M6 は、deterministic rule / evidence contract、M24-M27 adapter contract、diagnosis candidate 実装、improvement / auto-decision 実装、human-review pipeline 接続、ユーザー協業による redacted real-trace E2E を扱う。
