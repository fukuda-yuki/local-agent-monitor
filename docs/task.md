...
- Sprint4 M4 `dashboard prototype path` は開始済みである。Grafana JSON dashboard を第一候補とし、static report、repository-local preview と同じ基準で比較する。
- Sprint4 の後続候補は M5 review and handoff とする。
