...
利用者同意 workflow、共有サービス運用、access control 実装、retention 実装、masking / redaction 運用は別 decision とする。
...
remote managed Langfuse / Collector endpoint を使う場合も、送信前に同じ安全条件を確認する。
