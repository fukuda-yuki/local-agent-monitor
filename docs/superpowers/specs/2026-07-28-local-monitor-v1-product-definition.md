...
Parent: Issue #117  
IA specification: [`docs/specifications/interfaces/local-monitor-v1-ia.md`](../../specifications/interfaces/local-monitor-v1-ia.md)

This document supersedes the earlier defect-ledger draft and the retired Revision 12 IA requirements. Historical sprint records remain evidence of the implementation at that time; they are not the current product definition.
