...
This is preparation evidence at `matrix_prep_sha`
`5180a0424ff5488354a3e173c74b7e931d28679d`. It does not classify a final row.
...
| #105 | Automated candidate `78958f2e...` passed 6,548 tests; current-user candidate live evidence at `133cb79...` | The evidence branch is not an ancestor of this preparation branch. Live GitHub candidate promotion/exact navigation and uninstall are `failed` product-defect rows, not external blockers or passes; #105 remains open |
...
and the failed #105 candidate live rows remain final-candidate coverage gaps.
Historical raw captures and databases are never copied into this work item.
