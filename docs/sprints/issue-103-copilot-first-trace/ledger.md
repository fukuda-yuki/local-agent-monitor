...
| 103-D | In progress | projection RED `8650465`; GREEN `0f85b8b` | disposition/migration/worker/compatibility 77/77 PASS; Doctor migration 12/12 PASS; no sleep/retry | projection RED and final GREEN re-reviews PASS C0/I0/M0 | source matrices, privacy, simultaneous Observe / SQLite lock, full regressions |
