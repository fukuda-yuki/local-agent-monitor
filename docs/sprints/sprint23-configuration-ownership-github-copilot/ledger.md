...
| Transaction and rollback | #66 | In progress through Task 6a0b1 | `2d88eff..5ba62b3` | journal/store, exact artifact reuse, terminal/active Apply recovery, file, single-environment, mixed active/committed rollback recovery, committed lagging-ledger reconciliation, notification ambiguity/replay recovery, apply/compensation, lock-lifetime evidence, rollback journal supersession primitive, and fault/rebind hardening evidence above | Tasks through 6a0b1 and Lock A-C PASS/APPROVED | same-byte regular-file identity is a nonblocking residual; lock lifetime Task 6a0b2 and normal rollback producer Task 6a remain pending |
...
| Rollback journal supersession atomicity and rebind | Deterministic fault injection across replacement, reopen, and identity checks | Task 6a0a/6a0b1 focused 34/34; Journal 181/181; Storage+Journal 239/239; independent implementation, security, concurrency, and integration reviews PASS/APPROVED; same-byte regular-file identity is a nonblocking residual |
