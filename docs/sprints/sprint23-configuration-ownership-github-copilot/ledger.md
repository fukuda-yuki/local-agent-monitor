...
| Transaction and rollback | #66 | In progress through Task 5d1 | `2d88eff..88a87c2` | journal/store, exact artifact reuse, terminal reconciliation/notification replay, apply/compensation, and lock-lifetime evidence above | Tasks through 5d1 and Lock A-C PASS/APPROVED | active Apply/compensation recovery and rollback remain |
