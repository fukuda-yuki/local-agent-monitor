...
| Transaction and rollback | #66 | In progress through Task 5d0d | `2d88eff..ec7c980` | journal/store, exact artifact reuse, apply/compensation, and full lock-lifetime evidence above | Tasks through 5d0d and Lock A-C PASS/APPROVED | restart recovery and rollback remain |
