...
| Transaction and rollback | #66 | In progress through Task 5d prerequisites | `2d88eff..d06ffcc` | journal/store, backup reuse, apply/compensation, and full lock-lifetime evidence above | Tasks through 5c plus 5d0a-c and Lock A-C PASS/APPROVED | Apply artifact-resume wiring, restart recovery, and rollback remain |
