...
export function buildAgentForest(agents, parallelGroups) {
    ...
    for (const agent of Array.isArray(agents) ? agents : []) {
        ...
        if (agent.caller_agent_span_id === null || agent.caller_agent_span_id === undefined) roots.push(node);
